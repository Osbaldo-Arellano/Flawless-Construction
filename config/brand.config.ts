...
export const brandConfig = {
  ...
  company: {
    ...
    phone: "",           // fill in via Supabase
    address: "Oregon",  // fill in via Supabase
  },
  ...
  assets: {
    logo: {
      light: "/roofer-pro/logo-light.svg",
      dark: "/roofer-pro/logo-dark.svg",
      favicon: "/favicon.ico",
    },
    hero: {
      image: "/roofer-pro/hero.jpg",
  ...
  // ============================================
  // HARP PROGRAM SPOTLIGHT SECTION
  // ============================================
  harp: {
    headline: "About HARP",
  ...
  gallery: {
    ...
    items: [
      // Replace with real client photos (will pull from Supabase brand_photos)
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call Us",                              href: "tel:" },       // fill in via Supabase
          { label: "Oregon",                               href: "#contact" },   // fill in via Supabase
        ],
      },
    ],
    social: [
      { platform: "facebook",  url: "https://facebook.com" },   // fill in via Supabase
      { platform: "instagram", url: "https://instagram.com" },  // fill in via Supabase
    ],
