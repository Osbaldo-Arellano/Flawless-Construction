    ...
    <section id="before-after" className="scroll-mt-28 py-20 lg:py-32 overflow-hidden bg-background">
      <div className="container mx-auto px-4">
        ...
        <AnimateOnScroll animation="fade-up" triggerOnce={false}>
          ...
          {/* Captions */}
          <div className="flex justify-between max-w-5xl mx-auto mt-3 px-1">
            <p className="text-xs text-muted-foreground">{before.title}</p>
            <p className="text-xs text-muted-foreground">{after.title}</p>
          </div>
        </AnimateOnScroll>
